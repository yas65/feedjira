...
describe Feedjira do
  describe '#fetch_and_parse' do
    it 'fetches and parses an Atom feed' do
      feed = Feedjira.fetch_and_parse 'http://feedjira.com/blog/feed.xml', connection: Faraday.default_connection
    ...
    it 'fetches and parses an RSS feed' do
      feed = Feedjira.fetch_and_parse 'http://tenderlovemaking.com/feed/', connection: Faraday.default_connection
